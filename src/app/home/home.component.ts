...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [HeaderComponent, PaperMidiaComponent, BlocoDemonstrativoComponent, CardProdutoComponent, categoriasComponent, CarrinhoComponent, CardCarrinhoComponent, CardComponent, PaginaProdutoComponent],
